...
- Import the class in the appdelegate, set the viewcontroller in a navigationcontroller as the rootviewcontroller of the window. (we’ve done this 10 times, they should have this down)
